...
```{r first-few-lines, echo=FALSE, comment=""}
...
You can display an entire column similarly. There is an important difference in the display here. When you display a single column, it will fit more than one data point in the same row to save space. This is an important but very subtle change. It is not important at this stage of the class, however.
...
`r readLines("../dat/fat-data-dictionary.txt")[3]`
