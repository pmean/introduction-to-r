...
histogram_enhanced <- ggplot(fd2, aes(x=ht)) + 
  geom_histogram(fill="white", color="black", binwidth=3, na.rm=TRUE) +
  xlab("Height in inches") +
  scale_x_continuous(
    breaks=c(63, 66, 69, 72, 75, 78), 
    labels=c("62-64", "65-67", "68-70", "71-73", "74-76", "77-79"))
...
```{r scatterplot01}
scatterplot_default <- ggplot(fd2, aes(x=abdomen, y=fat_b)) +
  geom_point()
...
`r readLines("../dat/sleep-data-dictionary.txt")[3]`
