...
Here's an example of a very large file, where fixed width format makes sense. There are 16,710 rows in the data set, each row (except the last one) have 2,455 columns. There are 944 variables. It's a very big file, and putting in 943 commas in each of 16,710 rows would make the file even worse.
...
+ No formal data dictionary, but here is a description
  ...
  + Found at https://stats.idre.ucla.edu/r/dae/logit-regression/
