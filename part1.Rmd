...
# Part 1a: A brief technical note.
...
# Part 1b. A brief pair of definitions
...
# Part 1c. Read in the percentage of body fat data set and add variable names.
...
# Part 1d. Displaying parts of your data set and missing value codes.

To list just part of a data frame, you can use a matrix style of notation.
...
There is a short cut for displaying a particular column that uses the $ sign.
...
# part 1i. Saving pieces of your output using cut and paste
