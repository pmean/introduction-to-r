...
Examples of categorical variables are sex (Male or Female),
race/ethnicity (Caucasion, African American, Hispanic, Asian,
Native American, multiracial, or other), Cancer stage (I, II, III,
or IV), birth delivery type (Vaginal, C-section). 
...
Examples of continuous variables are Birth weight in grams,
getational age, fasting LDL level.
