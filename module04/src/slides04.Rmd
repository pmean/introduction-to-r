...
![Barplot of proportions](../images/barplot3.png)
...
ggsave("../images/barplot5.png", proportions_barplot, width=4, height=4)
```

![Barplot of counts](../images/barplot5.png)
...
The Powerpoint slide won't fit the entire table in, so you have to use your imagination a bit here.
